...
if test -f "extraFlats.psv, extraLevels.psv, extraTrims.psv, extraStreetTypes.psv, extraPostcodeSA1LGA.psv, extraLocality.psv" ; then
	echo "extraFlats.psv, extraLevels.psv, extraTrims.psv, extraStreetTypes.psv, extraPostcodeSA1LGA.psv and extraLocality.psv already created"
